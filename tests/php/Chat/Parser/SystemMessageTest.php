...
class SystemMessageTest extends TestCase {
	...
	public static function dataParseMessage(): array {
		return [
			...
			['owner_promoted', ['user' => 'user'], 'recipient',
				'{actor} promoted {user} to owner',
				['actor' => ['id' => 'actor', 'type' => 'user'], 'user' => ['id' => 'user', 'type' => 'user']],
			],
			['owner_promoted', ['user' => 'user'], 'user',
				'{actor} promoted you to owner',
				['actor' => ['id' => 'actor', 'type' => 'user'], 'user' => ['id' => 'user', 'type' => 'user']],
			],
			['owner_promoted', ['user' => 'user'], 'actor',
				'You promoted {user} to owner',
				['actor' => ['id' => 'actor', 'type' => 'user'], 'user' => ['id' => 'user', 'type' => 'user']],
			],
			['owner_demoted', ['user' => 'user'], 'recipient',
				'{actor} demoted {user} from owner',
				['actor' => ['id' => 'actor', 'type' => 'user'], 'user' => ['id' => 'user', 'type' => 'user']],
			],
			['owner_demoted', ['user' => 'user'], 'user',
				'{actor} demoted you from owner',
				['actor' => ['id' => 'actor', 'type' => 'user'], 'user' => ['id' => 'user', 'type' => 'user']],
			],
			['owner_demoted', ['user' => 'user'], 'actor',
				'You demoted {user} from owner',
				['actor' => ['id' => 'actor', 'type' => 'user'], 'user' => ['id' => 'user', 'type' => 'user']],
			],
	...
	public function testParseMessageThrows(?string $return): void {
		/** @var IComment&MockObject $comment */
		$comment = $this->createStub(IComment::class);
	...
	public function testGetFileFromNodeIdWithoutParticipantNotFound(): void {
		$room = $this->createStub(Room::class);
